...
// This is a quick example of file IO complemented with struct allocation and data storing.
int main() {
    FILE *fp;
    Log *list;
    char temp[10];
    ...
    if (fp == NULL) {
        ...
        // The logfile contains one integer at the beginning to indicate the amount of entries. Each entry contains date and the corresponding C programming topic.
